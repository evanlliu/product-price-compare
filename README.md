# 商品比价器 Price Compare v1.0.68

本版本基于 **v1.0.67** 继续迭代，在商家 / 渠道配置中新增背景色维护，并将商家背景色同步展示到价格记录页面。

## v1.0.68 更新内容

- 修复移动端卡片背景色过淡、几乎不可见的问题。
- 商家背景色现在会作为移动端卡片的主背景显示，并自动把偏深颜色柔化成浅色背景。
- 示例数据内置抖音、淘宝、拼多多、京东的推荐浅色背景。
...
4. **版本号同步更新**
   - `index.html` 版本号更新为 `v1.0.68`
   - `app.js` 版本号更新为 `v1.0.68`
   - 示例 `data.json` 版本号更新为 `v1.0.68`
